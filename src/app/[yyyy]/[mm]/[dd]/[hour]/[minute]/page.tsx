...
import { Buildings, BusTime, Caption, Style } from "../../../../../components/Types";
...
export default function Home({params}:{params:{yyyy:number,mm:number,dd:number,hour:number,minute:number}}){
    let {yyyy,mm,dd,hour,minute}=params;
    let now:Date
    try{
        now=new Date(yyyy,mm,dd,hour,minute,0)
